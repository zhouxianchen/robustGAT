...
def load_cora_data():
    ...
    return g, features, labels, train_mask, test_mask,data.graph


if __name__== "__main__":
    # g, features, labels, train_mask, test_mask, adj= load_cora_data()
    ...
    model = GCN(nfeat=features.shape[1],
                ...
                dropout=0.05, device='cpu')
    model.fit(features, adj, labels, idx_train, idx_val=None)
    model.test(idx_test)
